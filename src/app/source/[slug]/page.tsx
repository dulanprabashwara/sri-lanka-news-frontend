...
const SLUG_CANDIDATES: Record<string, string[]> = {
  ...
  "lakbima": ["lakbima-news", "lakbima"],
  "lakbima-news": ["lakbima-news", "lakbima"],
...
const STATIC_SOURCES: Record<string, Source> = {
  ...
  "lakbima": { name: "Lakbima News", slug: "lakbima-news", baseUrl: "https://lakbima.news", defaultLanguage: "SI" as Language },
