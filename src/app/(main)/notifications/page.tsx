...
import { Check, CheckCircle2, Settings, Bell, ArrowRight, Loader2 } from "lucide-react";
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-3 shrink-0">
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 rounded-lg border border-border bg-surface px-3 py-2 text-xs font-semibold text-foreground hover:bg-surface-muted transition-colors"
          >
      ...
      <Surface variant="elevated" className="divide-y divide-border overflow-hidden p-0">
        {isLoading ? (
          ...
          <div className="p-8 text-center text-foreground-secondary">
            <p className="text-sm font-semibold">Unable to load notifications at this time.</p>
          </div>
...
function NotificationItem({
  ...
  const ctaLabel = targetPath?.includes("/article/") ? "View Article" : "View Story";
